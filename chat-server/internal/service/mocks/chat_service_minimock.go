...
//go:generate minimock -i github.com/ivankornilov/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, usernames []string) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) ExpectUsernamesParam2(usernames []string) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, usernames []string)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, usernames []string) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, usernames []string) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, usernames []string) (i1 int64, err error) {
